...
if start_button:
    ...
    st.session_state['df_experiment_result'] = pd.concat([st.session_state['df_experiment_result'], pd.DataFrame(data=[[st.session_state['experiment_no'], number_of_trials, mean]], columns=['no', 'iteraciones', 'media'])], axis=0)
